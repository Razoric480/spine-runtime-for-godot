...
void SpineSpriteAnimateDialog::_init() {
	...
	animate_dialog_tree->set_column_title(0, "Animation");
	animate_dialog_tree->set_column_title(1, "Loop");
	animate_dialog_tree->set_column_title(2, "Track ID");
